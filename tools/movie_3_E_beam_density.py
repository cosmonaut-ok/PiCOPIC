...
def run(config_path, clim_e_r, clim_e_z, rho_beam_scale, video_file=None,
        time_range=None, cmap=None, frame_step=1, frame_size=None, dry_run=False, view=False,
        use_grid=False, plot_image_interpolation='nearest'):

    if not cmap: cmap='terrain'
    ...
    clim_rho_beam=[0, reader.meta.beams[0].bunch_density * rho_beam_scale] # try to update clim_rho_beam
