...
#ifndef _COLLISIONS_SK98M_HPP_
#define _COLLISIONS_SK98M_HPP_
...
class CollisionsSK98M : public Collisions
{
public:
  CollisionsSK98M(void) {};
  CollisionsSK98M(Geometry* _geometry, TimeSim *_time, vector <SpecieP *> _species_p);
  ~CollisionsSK98M(void) {};
...
#endif // end of _COLLISIONS_SK98M_HPP_
